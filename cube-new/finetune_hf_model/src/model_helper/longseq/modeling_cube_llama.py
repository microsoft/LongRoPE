...
if 'ATTENTION_TYPE' in os.environ:
    if os.environ['ATTENTION_TYPE'] == "ring_attn":
        # FT setting: Use ring attn: register on single file
        pass
    elif os.environ['ATTENTION_TYPE'] == "flash_attn_mask":
        # FT/SFT setting: Attention Use mask
        register('b l^ num_heads hd^, b s^ num_heads hd^, b s^ num_heads vd^, b l^ -> b l^ num_heads vd^')(cube_llama_flash_attention_forward)
    elif os.environ['ATTENTION_TYPE'] == "flash_attn_no_mask":
        ...
        raise ValueError("ATTENTION_TYPE not in [ring_attn, flash_attn_mask, flash_attn_no_mask]")
