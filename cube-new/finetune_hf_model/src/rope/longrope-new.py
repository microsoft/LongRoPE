...
class LlamaLongRoPEScaledRotaryEmbedding(LlamaRotaryEmbedding):
    ...
    def forward(self, x, seq_len=None):
        ...
        inv_freq = 1.0 / (self.rescale_factors * (self.base ** (torch.arange(0, self.dim, 2).float() / self.dim)))
        ...
        self.cos_cached = emb_cos.to(x.dtype)
        self.sin_cached = emb_sin.to(x.dtype)
