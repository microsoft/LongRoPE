...
short_path = "/mnt/yiran/RedPajama-Data-1T-Sample-less-4k-tokenized-cat"
long_path = "/mnt/yiran/RedPajama-Data-1T-Sample-longer-4k-tokenized-random-x6"
...
# mix data
random_mix = concatenate_datasets([short_dataset, long_dataset])
print(random_mix)


# random_mix.save_to_disk("/mnt/yiran/RedPajama-Data-1T-Sample-longer-4k-tokenized-mix-random")


for i in tqdm(range(random_mix.num_rows)):
    sample = random_mix[i]
    
    if len(random_mix['input_ids']) != 4*1024:
...
# short_dataset_cat.save_to_disk()
