...
# ./script/hf_benchmark/4k-pose/longrope-la2-4k-filterx2-2000step.sh 3 ARC ; ./script/hf_benchmark/4k-pose/longrope-la2-4k-filterx2-2000step.sh 3 HELLASWAG ; ./script/hf_benchmark/4k-pose/longrope-la2-4k-filterx2-2000step.sh 3 MMLU ; ./script/hf_benchmark/4k-pose/longrope-la2-4k-filterx2-2000step.sh 3 TRUTHFULQA ;
...
MODEL_PATH=/ft_out_model/cube-la2-4k-128k-same-doc-fliter-2xdoc/ck-2_2000

METHOD="pi"
MARK="bs2_la2_4k_pose_filterx2-2000step"
FACTOR=1
