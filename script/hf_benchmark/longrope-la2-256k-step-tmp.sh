...
# ./script/hf_benchmark/longrope-la2-256k-step-tmp.sh 1 ARC 1.0 ; ./script/hf_benchmark/longrope-la2-256k-step-tmp.sh 1 ARC 1.11 ; ./script/hf_benchmark/longrope-la2-256k-step-tmp.sh 1 HELLASWAG 1.11 ; ./script/hf_benchmark/longrope-la2-256k-step-tmp.sh 1 MMLU 1.11 ; ./script/hf_benchmark/longrope-la2-256k-step-tmp.sh 1 TRUTHFULQA 1.11 ; ./script/hf_benchmark/longrope-la2-256k-step-tmp.sh 1 ARC 1.12 ; ./script/hf_benchmark/longrope-la2-256k-step-tmp.sh 1 HELLASWAG 1.12 ; ./script/hf_benchmark/longrope-la2-256k-step-tmp.sh 1 MMLU 1.12 ; ./script/hf_benchmark/longrope-la2-256k-step-tmp.sh 1 TRUTHFULQA 1.12 ; ./script/hf_benchmark/longrope-la2-256k-step-tmp.sh 1 ARC 1.13 ; ./script/hf_benchmark/longrope-la2-256k-step-tmp.sh 1 HELLASWAG 1.13 ; ./script/hf_benchmark/longrope-la2-256k-step-tmp.sh 1 MMLU 1.13 ; ./script/hf_benchmark/longrope-la2-256k-step-tmp.sh 1 TRUTHFULQA 1.13 ; 
...
MODEL_ARGS="model=${BASE_PATH}${MODEL_PATH},method=${METHOD},factor=${FACTOR},finetuned=true,tmps=${tmps},original_max_position_embeddings=4096,cache_dir=./cache_dir"
