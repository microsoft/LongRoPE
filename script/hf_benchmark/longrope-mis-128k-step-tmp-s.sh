...
# ./script/hf_benchmark/longrope-mis-128k-step-tmp-s.sh 3 ARC 1.0 ; ./script/hf_benchmark/longrope-mis-128k-step-tmp-s.sh 3 HELLASWAG 1.0 ; ./script/hf_benchmark/longrope-mis-128k-step-tmp-s.sh 3 MMLU 1.0 ; ./script/hf_benchmark/longrope-mis-128k-step-tmp-s.sh 3 TRUTHFULQA 1.0 ; ./script/hf_benchmark/longrope-mis-128k-step-tmp-s.sh 3 ARC 1.06 ; ./script/hf_benchmark/longrope-mis-128k-step-tmp-s.sh 3 HELLASWAG 1.06 ; ./script/hf_benchmark/longrope-mis-128k-step-tmp-s.sh 3 MMLU 1.06 ; ./script/hf_benchmark/longrope-mis-128k-step-tmp-s.sh 3 TRUTHFULQA 1.06 ; ./script/hf_benchmark/longrope-mis-128k-step-tmp-s.sh 3 ARC 1.07 ; ./script/hf_benchmark/longrope-mis-128k-step-tmp-s.sh 3 HELLASWAG 1.07 ; ./script/hf_benchmark/longrope-mis-128k-step-tmp-s.sh 3 MMLU 1.07 ; ./script/hf_benchmark/longrope-mis-128k-step-tmp-s.sh 3 TRUTHFULQA 1.07 ; ./script/hf_benchmark/longrope-mis-128k-step-tmp-s.sh 3 ARC 1.08 ; ./script/hf_benchmark/longrope-mis-128k-step-tmp-s.sh 3 HELLASWAG 1.08 ; ./script/hf_benchmark/longrope-mis-128k-step-tmp-s.sh 3 MMLU 1.08 ; ./script/hf_benchmark/longrope-mis-128k-step-tmp-s.sh 3 TRUTHFULQA 1.08 ; 
...
METHOD="longrope"
MARK="bs2_mis_128k_tmps${tmps}"
FACTOR=32
SPI_PARA="./script/hf_benchmark/low_scale/low_scale_la2_128k_4k.csv"

MODEL_ARGS="model=${BASE_PATH}${MODEL_PATH},method=${METHOD},factor=${FACTOR},finetuned=false,tmps=${tmps},original_max_position_embeddings=4096,cache_dir=./cache_dir,max_tokens=4100"
