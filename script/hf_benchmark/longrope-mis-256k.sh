...
MODEL_ARGS="model=${BASE_PATH}${MODEL_PATH},method=${METHOD},factor=${FACTOR},finetuned=false,original_max_position_embeddings=4096,max_tokens=4100,cache_dir=./cache_dir"
