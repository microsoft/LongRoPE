...
for tmps in tmps_steps:  
    for job_name in job_names:  
        # /mnt/yiran/LongRoPE-main/LongRoPE/script/hf_benchmark/tmp-search/ft_out_model/cube_256k_from_128k/ck-600/-ARC-longrope-bs2_la2_256k_tmps1.0.json
        file_template = "-{job_name}-longrope-bs2_la2_256k_tmps{tmps}.json"  
        file_name = file_template.format(tmps=tmps, job_name=job_name)  
        file_path = f'script/hf_benchmark/tmp-search/ft_out_model/cube_256k_from_128k/ck-600/{file_name}'  
