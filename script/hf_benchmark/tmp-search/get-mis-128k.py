...
for tmps in tmps_steps:  
    for job_name in job_names:  
        # /mnt/yiran/LongRoPE-main/LongRoPE/script/hf_benchmark/tmp-search/ft_out_model/cube-mis-128k-bf16/ck-1_1000-ARC-longrope-bs2_mis_128k_tmps1.0.json
        file_template = "ck-1_1000-{job_name}-longrope-bs2_mis_128k_tmps{tmps}.json"  
        file_name = file_template.format(tmps=tmps, job_name=job_name)  
        file_path = f'script/hf_benchmark/tmp-search/ft_out_model/cube-mis-128k-bf16/{file_name}'  
