...
# run job
# ./script/hf_benchmark/tmp-search/longrope-mis-128k-step-tmp-s.sh 2 ARC 1_100

# mis-128k: 1.06-1.08
# ./script/hf_benchmark/tmp-search/longrope-mis-128k-step-tmp-s.sh 2 ARC 1.0 ; ./script/hf_benchmark/tmp-search/longrope-mis-128k-step-tmp-s.sh 2 HELLASWAG 1.0 ; ./script/hf_benchmark/tmp-search/longrope-mis-128k-step-tmp-s.sh 2 MMLU 1.0 ; ./script/hf_benchmark/tmp-search/longrope-mis-128k-step-tmp-s.sh 2 TRUTHFULQA 1.0 ; ./script/hf_benchmark/tmp-search/longrope-mis-128k-step-tmp-s.sh 2 ARC 1.06 ; ./script/hf_benchmark/tmp-search/longrope-mis-128k-step-tmp-s.sh 2 HELLASWAG 1.06 ; ./script/hf_benchmark/tmp-search/longrope-mis-128k-step-tmp-s.sh 2 MMLU 1.06 ; ./script/hf_benchmark/tmp-search/longrope-mis-128k-step-tmp-s.sh 2 TRUTHFULQA 1.06 ; 

# ./script/hf_benchmark/tmp-search/longrope-mis-128k-step-tmp-s.sh 2 ARC 1.07 ; ./script/hf_benchmark/tmp-search/longrope-mis-128k-step-tmp-s.sh 2 HELLASWAG 1.07 ; ./script/hf_benchmark/tmp-search/longrope-mis-128k-step-tmp-s.sh 2 MMLU 1.07 ; ./script/hf_benchmark/tmp-search/longrope-mis-128k-step-tmp-s.sh 2 TRUTHFULQA 1.07 ; ./script/hf_benchmark/tmp-search/longrope-mis-128k-step-tmp-s.sh 2 ARC 1.08 ; ./script/hf_benchmark/tmp-search/longrope-mis-128k-step-tmp-s.sh 2 HELLASWAG 1.08 ; ./script/hf_benchmark/tmp-search/longrope-mis-128k-step-tmp-s.sh 2 MMLU 1.08 ; ./script/hf_benchmark/tmp-search/longrope-mis-128k-step-tmp-s.sh 2 TRUTHFULQA 1.08 ; 
...
MODEL_PATH="/ft_out_model/cube-mis-128k-bf16/ck-1_1000"

METHOD="longrope"
MARK="bs2_mis_128k_bf16_tmps${tmps}"
FACTOR=32
# SPI_PARA=
