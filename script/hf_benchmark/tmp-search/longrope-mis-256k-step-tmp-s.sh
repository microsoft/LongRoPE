...
# run job
# ./script/hf_benchmark/tmp-search/longrope-mis-128k-step-tmp-s.sh 3 ARC 1_100

# mis-256k: 1.05-1.07
# ./script/hf_benchmark/tmp-search/longrope-mis-256k-step-tmp-s.sh 3 ARC 1.0 ; ./script/hf_benchmark/tmp-search/longrope-mis-256k-step-tmp-s.sh 3 HELLASWAG 1.0 ; ./script/hf_benchmark/tmp-search/longrope-mis-256k-step-tmp-s.sh 3 MMLU 1.0 ; ./script/hf_benchmark/tmp-search/longrope-mis-256k-step-tmp-s.sh 3 TRUTHFULQA 1.0 ; ./script/hf_benchmark/tmp-search/longrope-mis-256k-step-tmp-s.sh 3 ARC 1.05 ; ./script/hf_benchmark/tmp-search/longrope-mis-256k-step-tmp-s.sh 3 HELLASWAG 1.05 ; ./script/hf_benchmark/tmp-search/longrope-mis-256k-step-tmp-s.sh 3 MMLU 1.05 ; ./script/hf_benchmark/tmp-search/longrope-mis-256k-step-tmp-s.sh 3 TRUTHFULQA 1.05 ; 

# ./script/hf_benchmark/tmp-search/longrope-mis-256k-step-tmp-s.sh 3 ARC 1.06 ; ./script/hf_benchmark/tmp-search/longrope-mis-256k-step-tmp-s.sh 3 HELLASWAG 1.06 ; ./script/hf_benchmark/tmp-search/longrope-mis-256k-step-tmp-s.sh 3 MMLU 1.06 ; ./script/hf_benchmark/tmp-search/longrope-mis-256k-step-tmp-s.sh 3 TRUTHFULQA 1.06 ; ./script/hf_benchmark/tmp-search/longrope-mis-256k-step-tmp-s.sh 3 ARC 1.07 ; ./script/hf_benchmark/tmp-search/longrope-mis-256k-step-tmp-s.sh 3 HELLASWAG 1.07 ; ./script/hf_benchmark/tmp-search/longrope-mis-256k-step-tmp-s.sh 3 MMLU 1.07 ; ./script/hf_benchmark/tmp-search/longrope-mis-256k-step-tmp-s.sh 3 TRUTHFULQA 1.07 ; 
...
METHOD="longrope"
MARK="bs2_mis_256k_bf16_tmps${tmps}"
FACTOR=64
# SPI_PARA="./script/hf_benchmark/tmp-search/low_scale/low_scale_mis_128k_4k.csv"

MODEL_ARGS="model=${BASE_PATH}${MODEL_PATH},method=${METHOD},factor=${FACTOR},finetuned=false,tmps=${tmps},original_max_position_embeddings=4096,cache_dir=./cache_dir,max_tokens=4096"
