...
script/needle/1-cube_longrope_mis_128k_bf16_step_debug_prompt_needle_origin.sh 1_700 ANTHROPIC_TEMPLATE_ORIGINAL
script/needle/1-cube_longrope_mis_128k_bf16_step_debug_prompt_needle_origin.sh.sh 1_1000 ANTHROPIC_TEMPLATE_ORIGINAL
