...
echo "cube-mis-256k-bf16-step-1000 | needle origin"
...
name="11-cube_longrope_mis_256k_bf16_from_1000_ck_${ck_step}_debug_${prompt_name}_needle_origin"
...
python evaluation/needle/visualize.py --name 11-800k-bf16-256k-origin --path evaluation/needle/result/$name/ck-$ck_step/