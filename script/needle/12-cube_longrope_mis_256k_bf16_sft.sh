...
mistral_128k_sft="${path_team}/ft_out_model/cube-mis-128k-bf16/ck-${ck_step}"
...
echo "cube-mis-128k-bf16-step-700 | needle origin"

declare -A setting

# longrope 128k
setting["longrope_128k"]="-m ${mistral_128k} --method longrope --finetuned --factor 32.0"
...
name="10-cube_longrope_mis_128k_bf16_ck_${ck_step}_debug_${prompt_name}_needle_origin"
...
python evaluation/needle/visualize.py --name 10-2m-bf16-128k-origin --path evaluation/needle/result/$name/ck-$ck_step/