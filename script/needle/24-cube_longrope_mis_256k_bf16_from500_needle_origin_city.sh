...
# for 23 citys
for city_idx in $(seq 0 3 62); do  
    name="24-cube_longrope_mis_256k_bf16_from500_ck_${ck_step}_debug_needle_origin_city_${city_idx}"
    ...
    CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 $torch_path/torchrun \
        ...
        --seq_series "400000,525000,1050000" \
        --city_idx $city_idx \
    ...
    # python evaluation/needle/visualize.py --name 24-city-bf16-256k-${city_idx} --path evaluation/needle/result/$name/ck-$ck_step/
