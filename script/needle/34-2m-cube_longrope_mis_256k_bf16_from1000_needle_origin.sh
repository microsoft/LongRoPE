...
name="33-1m-cube_longrope_mis_256k_bf16_from1000_ck_${ck_step}_needle_origin"
...
python evaluation/needle/visualize.py --name 34-1m-bf16-256k-from1000-origin --path evaluation/needle/result/$name/ck-$ck_step/