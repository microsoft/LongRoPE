...
nums=55
name="${nums}-2m-cube_longrope_mis_256k_sft_ck_${ck_step}_needle_origin"
...
for books_idx in "${books_list[@]}"; do  
    ...
    python evaluation/needle/visualize.py --name 55-file_idx-bf16-256k-origin-file-${books_idx} --path evaluation/needle/result/$name/ck-$ck_step/
