...
# setting["longrope_128k-static-512"]="--model ${path_dir}/ft_out_model/cube-128k-dim-piece-mono-500-#m0/ck-400/ --method longrope --longrope_para ./script/longrope_scale/512k_la2_128k.csv --factor 32.0"
...
longrope_pose_512k="${path_team}/ft_out_model/cube-128k-dim-piece-mono-500-#m0/ck-400/"



echo "cube-la2-128k- | needle origin"
