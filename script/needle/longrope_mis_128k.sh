...
# longrope 256k
setting["longrope_256k"]="-m ${model_256} --method longrope --longrope_para /mnt/yiran/2048k-mistral-256k/s-PI/evolution/test/result_alpha/mistral_262144_dim_mono_ppl9.csv --factor 64.0 --sliding_window_attention 262144"
...
python -u evaluation/needle/needle_in_haystack.py \
    ...
    --result_path ./evaluation/needle/result/longrope_mis_128k/ \
    ${setting["longrope_128k"]} \
    --flash_attn \
    --max_tokens 4000 \

) 2>&1  | tee evaluation/needle/logs/eval_longrope_mis_128k.log
