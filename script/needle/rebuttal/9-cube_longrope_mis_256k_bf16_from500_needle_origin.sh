...
mistral_256k="${path_team}/ft_out_model/longrope-256k-sft-mis/mis-256k-longalphaca-12k/ck-3_500"

echo "cube-mis-256k-sft-step-500 | needle origin"
...
name="9-cube_longrope_mis_256k_sft_ck_${ck_step}_debug_${prompt_name}_needle_origin"
...
python evaluation/needle/visualize.py --name 9-2m-sft-256k-origin --path evaluation/needle/result/$name/ck-$ck_step/