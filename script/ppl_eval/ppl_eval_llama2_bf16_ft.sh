...
setting["longrope_la2_128k_bf16"]="--model ${path_dir}/ft_out_model/cube-128k-bf16/ck-2_400/ --method longrope --finetuned --factor 32.0"
    ...
    for config in "${config_list[@]}"; do
        for max_tokens in "${max_tokens_list[@]}"; do
            ...
            python evaluation/perplexity.py \
                ...
                --tokens_step 2048 \
                --output_file "${output_dir}/proofpile_${config}_${max_tokens}.csv" \
