...
max_tokens_list=(8192 131072 262144 524288)
...
for ck_step in "${ck_list[@]}"; do
    # mis-1m from 128k
    setting["longrope_mistral_1M_from_128k-${ck_step}"]="--model ${path_team}/sft-mistral/run-mistral7b_128k_1m-bf16-2node-8gpu-bsz64-step1000/0/ck-1_${ck_step} --method longrope --longrope_para ${path_team}/ft_out_model/Pose-cube-datasets/1024k-mis-128k.csv --factor $((1048576 / 1048576))"


    # mis-1m from 256k
    setting["longrope_mistral_1M_from_256k-${ck_step}"]="--model ${path_team}/sft-mistral/run-mistral7b_256k_1m-bf16-2node-8gpu-bsz64-step1000/0/ck-1_${ck_step} --method longrope --longrope_para ${path_team}/ft_out_model/Pose-cube-datasets/1024k-mis-256k.csv --factor $((1048576 / 1048576))"
