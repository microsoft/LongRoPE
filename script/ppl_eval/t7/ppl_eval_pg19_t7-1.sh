...
# longrope 128k
setting["longrope_128k"]="--model ${path_dir}/ft_out_model/cube-128k-dim-piece-mono-500-#m0/ck-400 --method longrope --longrope_para ./evolution/test/result_alpha/ft_longrope_131072_result.csv --factor 32.0"

# longrope 256k
setting["longrope_256k"]="--model ${path_dir}/ft_out_model/cube_256k_from_128k/ck-600 --method longrope --longrope_para ./evolution/test/result_alpha/ft_longrope_262144_result_118.csv --factor 64.0"
